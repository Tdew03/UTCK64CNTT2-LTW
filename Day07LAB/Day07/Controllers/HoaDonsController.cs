...
namespace Day07.Controllers
{
    public class HoaDonsController : Controller
    {
        ...
        public HoaDonsController(QlbanHangLtwContext context)
        {
            _context = context;
        }
        ...
        {
            var qlbanHangLtwContext = _context.HoaDons.Include(h => h.MaKhachHangNavigation);
        ...
        public async Task<IActionResult> Create([Bind("MaHoaDon,MaKhachHang,NgayHoaDon")] HoaDon hoaDon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaHoaDon,MaKhachHang,NgayHoaDon")] HoaDon hoaDon)
        {
