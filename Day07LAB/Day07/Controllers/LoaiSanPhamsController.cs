...
namespace Day07.Controllers
{
    public class LoaiSanPhamsController : Controller
    {
        ...
        public LoaiSanPhamsController(QlbanHangLtwContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaLoai,TenLoai,TrangThai")] LoaiSanPham loaiSanPham)
        {
